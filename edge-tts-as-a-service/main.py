...
# AUDIO_DIR = "/home/haloocom/rakesh/edge-tts/testfiles"
...
#     file_name = data.get('file_name', DEFAULT_OUTPUT_FILE)
...
async def tts():
    ...
    print(f'Response time for /tts: {response_time} seconds')
